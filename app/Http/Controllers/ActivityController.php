...
class ActivityController extends Controller
{
    ...
    public function index()
    {
        ...
        $location_activities = DB::table('location_activities')->select("id"
        ,"Type"
        ,"Change")->get();
        $room_activities = DB::table('room_activities')->select("id"
        ,"Type"
        ,"Change")->get();

$category_activities = DB::table('category_activities')->select("id"
,"Type"
,"Change")->get();
